    ...
    const handleAddCorte = async (e) => {
        ...
        try {
          ...
          if (!response.ok) {
            ...
            throw new Error(alert(errorData.message || 'Erro ao adicionar corte'));
          }
    ...
    const handleDeleteCorte = async (corte) => { // Recebe o objeto corte completo
        ...
        try {
          ...
          if (!response.ok) {
            ...
            throw new Error(alert(errorData.message || 'Erro ao deletar corte'));
          }
    ...
    return(
        ...
        <section className="agenda" id="editar">
            ...
            <section className="agenda">
                <h2>Agendar corte</h2>
                <form onSubmit={handleAddCorte} id="formcorte">
